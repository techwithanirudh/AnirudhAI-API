...
describe("batch tests", () => {
    ...
    it("should retry 3 times.", async (done) => {
        ...
        const batcher = batch_1.default(size, sendTimeout, retryCount, retryBackoff);
        const logger = batcher.initPusher(async (batch) => {
            called();
            throw err;
        });
    ...
    it("should play nicely with `throttle`", async () => {
        ...
        const throttle = throttle_1.default(maxThrottle);
        ...
        const batch = batch_1.default(batchSize, 5000);
